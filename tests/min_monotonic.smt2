...
(rule (link #b00 #b01 #b00000001))
(rule (link #b00 #b11 #b00000100))
(rule (link #b00 #b10 #b00000011))

(rule (link #b01 #b00 #b00000001))
(rule (link #b01 #b10 #b00000001))
(rule (link #b01 #b11 #b00000100))

(rule (link #b10 #b00 #b00000011))
(rule (link #b10 #b01 #b00000001))
(rule (link #b10 #b11 #b00000001))

(rule (link #b11 #b00 #b00000100))
(rule (link #b11 #b01 #b00000100))
(rule (link #b11 #b10 #b00000001))
...
(rule (=>
  (and (split_path x y c1) ((_ min split_path 2) x y c1) (path x y c2) ((_ min path 2) x y c2)  (bvult c1 c2))
  (path x y c1)))

(query (path #b11 #b01 #b00000100) :print-answer true)
