...
template square_sparse_matrix<double, double>::square_sparse_matrix<static_matrix<double, double> >(static_matrix<double, double> const&, vector<unsigned int, true, unsigned int>&);
template square_sparse_matrix<mpq, mpq>::square_sparse_matrix<static_matrix<mpq, mpq> >(static_matrix<mpq, mpq> const&, vector<unsigned int, true, unsigned int>&);
template square_sparse_matrix<mpq, numeric_pair<mpq> >::square_sparse_matrix<static_matrix<mpq, numeric_pair<mpq> > >(static_matrix<mpq, numeric_pair<mpq> > const&, vector<unsigned int, true, unsigned int>&);
}
