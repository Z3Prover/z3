...
Z3_ADD_TACTIC(factor, "factor", "polynomial factorization.", mk_factor_tactic(m, p));
Z3_ADD_SIMPLIFIER(factor, "factor", "polynomial factorization.", mk_factor_simplifier(m, p, s));
