...
Z3_ADD_TACTIC(propagate_values2, "propagate-values2", "propagate constants.", mk_propagate_values2_tactic(m, p));
Z3_ADD_SIMPLIFIER(propagate_values, "propagate-values", "propagate constants.", alloc(propagate_values, m, p, s));
