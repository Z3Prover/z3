...
Z3_ADD_TACTIC(demodulator, "demodulator", "extracts equalities from quantifiers and applies them to simplify.", mk_demodulator_tactic(m, p));
Z3_ADD_SIMPLIFIER(demodulator, "demodulator", "extracts equalities from quantifiers and applies them to simplify.", alloc(demodulator_simplifier, m, p, s));
