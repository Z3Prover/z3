...
Z3_ADD_TACTIC(special_relations, "special-relations", "detect and replace by special relations.", mk_special_relations_tactic(m, p));
Z3_ADD_SIMPLIFIER(special_relations, "special-relations", "detect and replace by special relations.", alloc(special_relations_simplifier, m, p, s));
