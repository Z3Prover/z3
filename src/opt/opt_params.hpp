...
#define OPT_PARAMS_LIST(UINT_, BOOL_, DOUBLE_, STRING_, SYMBOL_) \
  ...
  BOOL_  (optsmt_nlsat,                    "optsmt_nlsat",                    true,      "optimize real objectives under nonlinear constraints exactly over nlsat cells (algebraic optima print as root-obj; unboundedness proven by nlqsat queries under an escalating rlimit budget)") \
