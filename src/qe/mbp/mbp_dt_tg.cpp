...
mbp_dt_tg::mbp_dt_tg(ast_manager& man, mbp::term_graph& tg, model& mdl, obj_hashtable<app> &vars_set, expr_sparse_mark &seen) {
...
family_id mbp_dt_tg::get_family_id() const { return m_impl->m_dt_util.get_family_id(); }
