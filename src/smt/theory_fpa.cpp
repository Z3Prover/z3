...
namespace smt {
    ...
    app * theory_fpa::fpa_value_proc::mk_value(model_generator & mg, vector<expr*> & values) {
        TRACE("t_fpa_detail",
    ...
    app * theory_fpa::fpa_rm_value_proc::mk_value(model_generator & mg, vector<expr*> & values) {
