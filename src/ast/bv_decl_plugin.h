...
public:
    ...
    app * mk_concat(std::span<expr * const> args) { return m_manager.mk_app(get_fid(), OP_CONCAT, args); }
    app * mk_concat(unsigned num, expr * const * args) { return mk_concat(std::span<expr * const>(args, num)); }
    ...
    app * mk_bv_or(std::span<expr * const> args) { return m_manager.mk_app(get_fid(), OP_BOR, args); }
    app * mk_bv_or(unsigned num, expr * const * args) { return mk_bv_or(std::span<expr * const>(args, num)); }
    app * mk_bv_and(std::span<expr * const> args) { return m_manager.mk_app(get_fid(), OP_BAND, args); }
    app * mk_bv_and(unsigned num, expr * const * args) { return mk_bv_and(std::span<expr * const>(args, num)); }
    app * mk_bv_xor(std::span<expr * const> args) { return m_manager.mk_app(get_fid(), OP_BXOR, args); }
    app * mk_bv_xor(unsigned num, expr * const * args) { return mk_bv_xor(std::span<expr * const>(args, num)); }
    ...
    app * mk_bv_mul(std::span<expr * const> args) const { return m_manager.mk_app(get_fid(), OP_BMUL, args); }
    app * mk_bv_mul(unsigned n, expr* const* args) const { return mk_bv_mul(std::span<expr * const>(args, n)); }
