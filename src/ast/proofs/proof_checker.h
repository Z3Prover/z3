...
private:
    ...
    bool match_op(expr const* e, decl_kind k, vector<expr*>& terms) const;
    ...
    bool match_or(expr const* e, vector<expr*>& terms) const;
    bool match_and(expr const* e, vector<expr*>& terms) const;
    bool match_app(expr const* e, func_decl*& d, vector<expr*>& terms) const;
