...
void bv1_blaster_simplifier::translate(dependent_expr_simplifier& other) {
    auto& dst = dynamic_cast<bv1_blaster_simplifier&>(other);
    auto& src_cfg = m_rw.cfg();
    auto& dst_cfg = dst.m_rw.cfg();
