...
public:
    ...
    app * mk_at_most_k(std::span<expr * const> args, unsigned k);
    app * mk_at_most_k(unsigned num_args, expr * const * args, unsigned k);
    app * mk_at_least_k(std::span<expr * const> args, unsigned k);
    app * mk_at_least_k(unsigned num_args, expr * const * args, unsigned k);
    app * mk_at_most_k(expr_ref_vector const& args, unsigned k) { return mk_at_most_k(std::span<expr * const>(args.data(), args.size()), k); }
    app * mk_at_least_k(expr_ref_vector const& args, unsigned k) { return mk_at_least_k(std::span<expr * const>(args.data(), args.size()), k); }
