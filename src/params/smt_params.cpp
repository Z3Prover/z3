...
void smt_params::updt_local_params(params_ref const & _p) {
    ...
    m_nseq_landing_probes = p.nseq_landing_probes();
    m_nseq_landing_probe_budget = p.nseq_landing_probe_budget();
    m_nseq_landing_probe_max = p.nseq_landing_probe_max();
...
void smt_params::display(std::ostream & out) const {
    ...
    DISPLAY_PARAM(m_nseq_landing_probes);
    DISPLAY_PARAM(m_nseq_landing_probe_budget);
    DISPLAY_PARAM(m_nseq_landing_probe_max);
