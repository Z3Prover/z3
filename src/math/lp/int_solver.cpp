...
namespace lp {
    ...
    constraint_dependency* int_solver::column_upper_bound_constraint(unsigned j) const {
        return lra.get_column_upper_bound_witness(j);
    }

    constraint_dependency* int_solver::column_lower_bound_constraint(unsigned j) const {
