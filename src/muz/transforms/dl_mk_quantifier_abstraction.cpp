...
namespace datalog {
    ...
    public:
        ...
        void insert(func_decl* old_p, func_decl* new_p, expr_ref_vector& sub, sort_ref_vector& sorts, vector<bool> const& bound) {
        ...
        void operator()(model_ref & old_model) override {
            ...
            for (unsigned i = 0; i < m_new_funcs.size(); ++i) {
                ...
                vector<bool> const& is_bound  = m_bound[i];
