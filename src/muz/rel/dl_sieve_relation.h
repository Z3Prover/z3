...
namespace datalog {
            ...
            */
            ...
            struct hash {
                unsigned operator()(const rel_spec & s) const {
                    return vector_hash<bool_hash>()(s.m_inner_cols)^s.m_inner_kind;
                }
            };
        };
    private:
        ...
        void collect_inner_signature(const relation_signature & s, const vector<bool> & inner_columns, 
    ...
    public:
        ...
        family_id get_relation_kind(const relation_signature & sig, const vector<bool> & inner_columns, 
                family_id inner_kind) {
        ...
        sieve_relation * mk_from_inner(const relation_signature & s, const vector<bool> & inner_columns, 
                relation_base * inner_rel) {
