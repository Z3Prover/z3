...
cmake -S llvm -B libcxx_msan -DCMAKE_BUILD_TYPE=Release -DLLVM_USE_SANITIZER=Memory -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++
cmake --build libcxx_msan --target cxx --parallel 4
