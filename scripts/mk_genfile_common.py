...
def mk_z3consts_js_internal(api_files, output_dir):
    """
        Generate ``z3consts.js`` from the list of API header files
        in ``api_files`` and write the output file into
        the ``output_dir`` directory
    ...
    z3consts  = open(os.path.join(output_dir, 'z3consts.js'), 'w')
    z3consts_output_path = z3consts.name
    z3consts.write('// Automatically generated file\n\n')

    z3consts.write('module.exports = {\n')
    for api_file in api_files:
        api = open(api_file, 'r')
