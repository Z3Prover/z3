...
def mk_java(java_src, java_dir, package_name):
  ...
  public static native boolean propagateConflict(Object o, long ctx, long solver, long javainfo, int num_fixed, long[] fixed, long num_eqs, long[] eq_lhs, long[] eq_rhs, long conseq);
