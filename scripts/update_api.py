...
def mk_dotnet(dotnet):
    ...
    dotnet.write('          public IntPtr C_idxs, L_idxs, pi_march_logits, pi_core_var_logits, pi_core_clause_logits, pi_model_logits;\n')
    dotnet.write('          public float is_sat_logit;\n')
    dotnet.write('        }\n')
    dotnet.write('        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]\n')
