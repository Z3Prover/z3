...
(assert
  (not
    (=
      (re.inter (re.inter (re.inter (re.++ (re.* re.allchar) (re.range "0" "9") (re.* re.allchar)) (re.++ (re.* re.allchar) (re.range "A" "Z") (re.* re.allchar))) ((_ re.loop 8 20) (re.union (re.union (re.union (re.range "a" "z") (re.range "A" "Z")) (re.range "0" "9")) (re.union (str.to_re "!") (str.to_re "@") (str.to_re "#") (str.to_re "$") (str.to_re "%"))))) (re.comp (re.inter (re.++ (re.* re.allchar) (re.range "0" "9") (re.* re.allchar)) (re.inter (re.++ (re.* re.allchar) (re.range "A" "Z") (re.* re.allchar)) ((_ re.loop 8 20) (re.union (re.union (re.union (re.range "a" "z") (re.range "A" "Z")) (re.range "0" "9")) (re.union (str.to_re "!") (str.to_re "@") (str.to_re "#") (str.to_re "$") (str.to_re "%"))))))))
