...
(assert
  (str.in_re x
    (re.union (re.inter (re.++ (str.to_re "#") ((_ re.loop 6 6) (re.union (re.range "0" "9") (re.range "a" "f") (re.range "A" "F")))) (re.comp (re.++ (str.to_re "#") ((_ re.loop 8 8) (re.union (re.range "0" "9") (re.range "a" "f") (re.range "A" "F")))))) (re.inter (re.comp (re.++ (str.to_re "#") ((_ re.loop 6 6) (re.union (re.range "0" "9") (re.range "a" "f") (re.range "A" "F"))))) (re.++ (str.to_re "#") ((_ re.loop 8 8) (re.union (re.range "0" "9") (re.range "a" "f") (re.range "A" "F"))))))))
