...
;; Transforms: demorgan_union, star_idemp, double_comp, inter_idemp
;; Status: unsat
;;
...
(assert (not (= (re.inter (re.comp (re.union (re.++ (re.++ (re.* (str.to_re "a")) (str.to_re "b")) (re.* (str.to_re "c"))) (re.++ (re.++ (re.* (str.to_re "d")) (str.to_re "e")) (re.* (str.to_re "f"))))) (re.union (re.++ (re.+ (str.to_re "x")) (re.* (str.to_re "y"))) (re.comp (re.++ (re.* (str.to_re "z")) (re.+ (str.to_re "w")))))) (re.inter (re.inter (re.comp (re.++ (re.++ (re.* (str.to_re "a")) (str.to_re "b")) (re.* (str.to_re "c")))) (re.comp (re.++ (re.inter (re.++ (re.* (str.to_re "d")) (str.to_re "e")) (re.++ (re.* (str.to_re "d")) (str.to_re "e"))) (re.* (str.to_re "f"))))) (re.union (re.++ (re.+ (str.to_re "x")) (re.* (re.* (str.to_re "y")))) (re.comp (re.++ (re.comp (re.comp (re.* (str.to_re "z")))) (re.+ (str.to_re "w")))))))))
