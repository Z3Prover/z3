...
;; Base: snort_sig
;; Transforms: concat_assoc, star_idemp, double_comp
;; Status: unsat
;;
...
(assert (not (= (re.inter (re.inter (re.++ (re.++ (re.* re.allchar) (str.to_re "GET")) (re.* re.allchar)) (re.++ (re.++ (re.* re.allchar) (str.to_re "/admin")) (re.* re.allchar))) (re.comp (re.++ (re.++ (re.* re.allchar) (str.to_re "safe=true")) (re.* re.allchar)))) (re.inter (re.inter (re.++ (re.++ (re.* re.allchar) (str.to_re "GET")) (re.* re.allchar)) (re.++ (re.++ (re.* re.allchar) (re.comp (re.comp (str.to_re "/admin")))) (re.* re.allchar))) (re.comp (re.++ (re.* (re.* re.allchar)) (re.++ (str.to_re "safe=true") (re.* re.allchar))))))))
