...
(assert (not (= (re.++ (str.to_re "#") (re.union ((_ re.loop 3 3) (re.union (re.union (re.range "0" "9") (re.range "a" "f")) (re.range "A" "F"))) ((_ re.loop 6 6) (re.union (re.union (re.range "0" "9") (re.range "a" "f")) (re.range "A" "F"))))) (re.union (re.++ (str.to_re "#") ((_ re.loop 3 3) (re.comp (re.comp (re.union (re.range "0" "9") (re.union (re.range "a" "f") (re.comp (re.comp (re.range "A" "F"))))))))) (re.++ (str.to_re "#") ((_ re.loop 6 6) (re.union (re.union (re.range "0" "9") (re.range "a" "f")) (re.range "A" "F"))))))))
