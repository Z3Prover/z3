...
;; Transforms: star_idemp, star_idemp, union_idemp
;; Status: unsat
;;
...
(assert (not (= (re.inter (re.comp (re.union (re.++ (re.++ (re.* (str.to_re "a")) (str.to_re "b")) (re.* (str.to_re "c"))) (re.++ (re.++ (re.* (str.to_re "d")) (str.to_re "e")) (re.* (str.to_re "f"))))) (re.union (re.++ (re.+ (str.to_re "x")) (re.* (str.to_re "y"))) (re.comp (re.++ (re.* (str.to_re "z")) (re.+ (str.to_re "w")))))) (re.inter (re.comp (re.union (re.++ (re.++ (re.* (re.* (str.to_re "a"))) (str.to_re "b")) (re.* (str.to_re "c"))) (re.++ (re.++ (re.* (re.* (str.to_re "d"))) (str.to_re "e")) (re.* (str.to_re "f"))))) (re.union (re.++ (re.+ (str.to_re "x")) (re.* (re.union (str.to_re "y") (str.to_re "y")))) (re.comp (re.++ (re.* (str.to_re "z")) (re.+ (str.to_re "w")))))))))
